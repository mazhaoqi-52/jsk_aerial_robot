...
if __name__ == '__main__':
    ...
    parser.add_argument('L', help='Length of the pendulum', default=1.883)
    parser.add_argument('D', help='Diameter of the pendulum', default=0.480)
    parser.add_argument('m', help='Mass of the object', default=3.45)
