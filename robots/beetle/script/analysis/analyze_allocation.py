...
thrust_max = 21.37  # N, maximum thrust per rotor (updated for current hardware)
thrust_min = 0
alpha_max = np.pi / 2  # rad, maximum tilt angle (90 degrees, updated for 180-degree range servos)
alpha_min = -np.pi / 2  # rad, minimum tilt angle (-90 degrees)
