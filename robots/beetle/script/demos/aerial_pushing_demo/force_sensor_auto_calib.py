...
def calibrate_force_sensor(service_name, topic_name, service_timeout,
                           topic_timeout, startup_delay,
                           wait_for_sample=True):
    """Wait for CFS readiness and synchronously zero its six-axis offset."""
    try:
...
def main():
    ...
    success = calibrate_force_sensor(
