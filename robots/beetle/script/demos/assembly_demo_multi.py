...
"""
Multi-robot sequential assembly demo
This version performs sequential assembly: first 1-2, then 2-3
For single pair assembly, use assembly_demo.py instead
"""
...
class AssemblyDemoMulti():
    def __init__(self):
        rospy.init_node("assembly_demo_multi")
    ...
    def main(self):
        ...
        sis.stop()
        rospy.loginfo("Multi-robot assembly demo completed with outcome: %s" % outcome)
        
if __name__ == '__main__':
    try:
        demo = AssemblyDemoMulti()
        demo.main()
