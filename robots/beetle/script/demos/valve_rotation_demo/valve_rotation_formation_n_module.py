...
def create_n_module_state_machine(module_ids_str):
    ...
    with sm:
        # State 1: Assemble UAVs
        smach.StateMachine.add(
            'ASSEMBLE',
            FormationAssembleState(),
            transitions={
                'succeeded': 'WAIT_AFTER_ASSEMBLE',
...
def main():
    ...
    try:
        ...
        rospy.loginfo("State sequence (with 3s waits):")
        rospy.loginfo("  ASSEMBLE -> [wait 3s] -> INITIALIZE -> [wait 3s] -> MOVE_TO_VALVE")
